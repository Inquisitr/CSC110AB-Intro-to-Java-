...
public class Employee implements Comparable
{
    ...
    */
    ...
    public int compareTo(Object obj )
    {
        ...
        //TODO: return  0 if getHireDate()s are equal
        if(getHireDate().equals(otherEmp.getHireDate())) result = 0;
        //      return -1 if this.getHireDate().precedes otherEmp getHireDate()
        else if (getHireDate().precedes(otherEmp.getHireDate())) result = -1;
        //      otherwise, return 1 (follows)
        return result;
    }
